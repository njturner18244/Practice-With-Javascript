...
function sum (arr, n) { // sum of numbers in array
      if (n <= 0) { //num is less than or eq 2 0, return 0
          return 0;
      } else {
          return sum (arr, n - 1) + arr [n - 1]; // then it evaluates first sum and adds the second part and returns sum
      }
}

sum([2, 3, 4], 1)

//returning golf score
